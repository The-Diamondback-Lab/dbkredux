# :turtle: DBK Redux Frontend

Built with React.js and Next.js, DBK Redux is the transformation project for the
University of Maryland's student-run newspaper, The Diamondback.
...
DBK Redux is the transformation project for the University of Maryland's
student-run newspaper, The Diamondback. Previously, the site was built using
[PageBuilder from Arc Publishing][1], but after a multitude of requests across
the organization, the need for a custom built site was clear.

The newly designed site was built using React.js and is server side rendered
using Next.js. The Diamondback continues to use WordPress as its content
management system.
